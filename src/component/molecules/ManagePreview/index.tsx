import { removeComponent } from "@/app/redux/features/selectedComponent/selectedComponentSlice"
...
const ManagePreview = ({ id }: {id: string }) => {
  ...
  return (
    <div className="relative flex justify-between">
      <div onClick={() => dispatch(switchMenu())} className="flex items-center gap-2 cursor-pointer">
      ...
      <div onClick={() => dispatch(removeComponent(id))} className="flex items-center gap-2 cursor-pointer">
