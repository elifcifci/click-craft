...
const ManagePreview = ({ id }: { id: string }) => {
  ...
  const handleEditItem = (e?: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    if (e) {
      e.stopPropagation()
    }
  ...
  return (
    <div className="flex gap-4 gradient-left rounded absolute top-[-20px] right-0 z-40">
      <EditIcon isOuter onClick={(e) => handleEditItem(e)} />
      <div onClick={(e) => handleRemoveItem(e)} className="p-2 cursor-pointer">
