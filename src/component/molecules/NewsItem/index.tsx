...
const NewsItem = ({ item }: INewsletterItem) => {
  return (
    <li className="lg:cursor-pointer overflow-hidden group relative">
      ...
      <img
        ...
        src={item.image.src}
        alt={item.image.alt}
        className="object-center object-cover lg:group-hover:scale-125 transition-all w-full h-full"
      />
    </li>
  );
};
