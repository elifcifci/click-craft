...
const Styles = ({ styles }: { styles: IStyleDataInterface }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-start gap-2">
      <p className="text-gray-lighter font-medium text-sm">Styles</p>
      <div className="flex flex-col gap-4 [&_label]:text-gray-lighter [&_input]:cursor-pointer">
        <fieldset className="flex flex-col items-center justify-start gap-1">
          <legend className="text-gray-lighter text-left w-full text-sm">Colors:</legend>
        ...
        <fieldset className="flex flex-col items-center justify-start gap-1">
          <legend className="text-gray-lighter w-full text-sm">Font Weight:</legend>
